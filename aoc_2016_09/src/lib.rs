...
mod tests {
    ...
    fn aoc_2016_09_a_example(#[case] input: &str, #[case] expected: usize) {
        println!("{}", input);
        assert_eq!(super::aoc_2016_09_a(input), expected);
    }
    ...
    fn aoc_2016_09_b_example(#[case] input: &str, #[case] expected: usize) {
        println!("{}", input);
        assert_eq!(super::aoc_2016_09_b(input), expected);
    }
